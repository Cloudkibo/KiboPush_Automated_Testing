...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Autoposting/button_Add Feed (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Autoposting/button_WordPress (2)'))
