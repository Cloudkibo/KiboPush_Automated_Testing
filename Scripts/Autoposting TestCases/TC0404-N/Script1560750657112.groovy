...
WebUI.verifyEqual(true,oRadioButton.get(0).isSelected())
WebUI.verifyEqual(false,oRadioButton.get(1).isSelected())
WebUI.verifyEqual(false,oRadioButton.get(2).isSelected())
