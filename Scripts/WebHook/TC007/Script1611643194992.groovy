...
WebUI.click(findTestObject('Object Repository/Webhook/Page_KiboChat  Api Settings/button_Disable'))

WebUI.click(findTestObject('Object Repository/Webhook/Page_KiboChat  Api Settings/div_Webhook Disabled'))
