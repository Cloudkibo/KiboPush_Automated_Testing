...
WebUI.click(findTestObject('Object Repository/Admin_Alerts/Page_KiboChat  Api Settings/div_Pending Session Alert'))

WebUI.setText(findTestObject('Object Repository/Admin_Alerts/Page_KiboChat  Api Settings/input_Set time (in mins) after which alert _c9ad92'), 
    '52')
