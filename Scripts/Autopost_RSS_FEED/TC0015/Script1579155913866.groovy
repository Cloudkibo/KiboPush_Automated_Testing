...
WebUI.callTestCase(findTestCase('Autopost_RSS_FEED/feed_delete'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/RSS_Feed/Page_KiboEngage  Rss Integration for News P_8908ba/a_Add Feed'))

WebUI.click(findTestObject('Object Repository/RSS_Feed/Page_ Rss Feeds/h3_Rss Feed'))
