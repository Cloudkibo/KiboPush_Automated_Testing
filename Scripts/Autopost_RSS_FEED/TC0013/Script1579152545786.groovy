...
WebUI.click(findTestObject('Object Repository/RSS_Feed/Page_ Rss Feeds/button_Preview in Messenger'))

WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/RSS_Feed/Page_ Rss Feeds/div_Preview message sent successfully to yo_1b7484'))
