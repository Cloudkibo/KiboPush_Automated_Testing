...
WebUI.selectOptionByValue(findTestObject('Object Repository/Manual_integeration/Page_KiboEngage  News Integration/select_Filter by StatusAllEnabledDisabled'), 
    'true', true)
WebUI.delay(2)
