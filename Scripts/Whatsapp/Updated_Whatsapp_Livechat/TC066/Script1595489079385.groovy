...
WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/button_Send'))

WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/div_Template Successfully Sent'))
