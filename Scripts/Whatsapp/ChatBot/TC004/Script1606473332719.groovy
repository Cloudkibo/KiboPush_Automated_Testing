...
//WebUI.click(findTestObject('Object Repository/Whatsp_chatBot/Page_KiboChat  Configure ChatBot/div_yes'))
WebUI.setText(findTestObject('Object Repository/Whatsp_chatBot/Page_KiboChat  Configure ChatBot/input_yes_react-select-3-input'), 
    'ok')

WebUI.sendKeys(findTestObject('Object Repository/Whatsp_chatBot/Page_KiboChat  Configure ChatBot/input_yes_react-select-3-input'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Whatsp_chatBot/Page_KiboChat  Configure ChatBot/svg_ok_css-19bqh2r'))
