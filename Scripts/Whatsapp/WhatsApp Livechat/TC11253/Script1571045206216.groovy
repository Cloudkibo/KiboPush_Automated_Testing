...
WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/i_Click here_la la-ellipsis-h (1) (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/span_Newest to Oldest'))
