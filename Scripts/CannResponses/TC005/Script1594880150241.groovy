...
WebUI.setText(findTestObject('Object Repository/cannResponses/Page_KiboChat  Api Settings/input__name'), 'test1')
...
WebUI.click(findTestObject('Object Repository/cannResponses/Page_KiboChat  Api Settings/div_test1 Canned Code already exists'))
