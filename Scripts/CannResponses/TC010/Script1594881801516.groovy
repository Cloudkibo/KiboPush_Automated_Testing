...
WebUI.click(findTestObject('Object Repository/cannResponses/Page_KiboChat  Api Settings/div_test1'))

WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/cannResponses/Page_KiboChat  Api Settings/p_test1'))
