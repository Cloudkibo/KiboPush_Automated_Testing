...
WebUI.click(findTestObject('Object Repository/chatbot/Page_KiboChat  Configure ChatBot/button_Create New Backup'))

WebUI.doubleClick(findTestObject('Object Repository/chatbot/Page_KiboChat  Configure ChatBot/div_Backup created successfully'))
