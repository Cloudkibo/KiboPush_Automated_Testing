...
WebUI.setText(findTestObject('Object Repository/sponsor_messaging_v2/Page_KiboEngage  Create Sponsored Message/input_Create New Campaign_form-control m-input'), 
    'camp1')
