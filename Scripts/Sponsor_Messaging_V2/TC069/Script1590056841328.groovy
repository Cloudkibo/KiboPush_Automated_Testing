...
WebUI.callTestCase(findTestCase('Sponsor_Messaging_V2/TC067'), [:], FailureHandling.STOP_ON_FAILURE)
...
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_ Add Action'))
//
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_Assign Tag'))
//
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_Unassign Tag'))
//
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_Open Website'))
//
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_Set custom field'))
//
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_Subscribe to sequence'))
//
//WebUI.click(findTestObject('Object Repository/sponsor_v2/Page_KiboEngage  Create Sponsored Message/button_Unsubscribe from sequence'))
//
