...
WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Edit Messenger Code/a_QRCode'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_KiboEngage  Edit Messenger Code/a_Download Image'), 5)
