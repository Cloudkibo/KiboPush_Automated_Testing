...
WebUI.setText(findTestObject('Object Repository/user_input/Page_KiboEngage  Create Broadcast/textarea_Question 1 for User_form-control (1) (1)'), 
    'g')

WebUI.selectOptionByValue(findTestObject('Object Repository/user_input/Page_KiboEngage  Create Broadcast/select_Select a Reply TypeTextNumberEmailPh_d1a2b6 (1) (1)'), 
    'text', true)

WebUI.setText(findTestObject('Object Repository/user_input/Page_KiboEngage  Create Broadcast/input_concat(  Skip   button text)_form-con_78df78 (1)'), 
    '')
