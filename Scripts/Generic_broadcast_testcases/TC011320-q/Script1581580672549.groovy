...
WebUI.click(findTestObject('Object Repository/quickreplies/Page_KiboEngage  Create Broadcast/button_Delete'))

WebUI.click(findTestObject('Object Repository/quickreplies/Page_KiboEngage  Create Broadcast/p_Do you want to delete this quick reply'))

WebUI.click(findTestObject('Object Repository/quickreplies/Page_KiboEngage  Create Broadcast/button_No'))
