...
WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/h6_CreateUpdate Contact Properties'))

WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/h6_HubSpot CreateUpdate Contact Properties'))
...
WebUI.delay(5)
WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/select_Select a FieldFirst NameLast NameFul_47d496'))

WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/select_Select a FieldAnnual RevenueCityClos_c8679f'))
