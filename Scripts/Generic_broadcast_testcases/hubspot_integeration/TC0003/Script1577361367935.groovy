...
WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/Page_KiboEngage  Create Broadcast/h6_Get Contact Properties (1)'))

WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/Page_KiboEngage  Create Broadcast/h6_HubSpot Get Contact Properties (1)'))

WebUI.delay(2)

WebUI.selectOptionByValue(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/Page_KiboEngage  Create Broadcast/select_Enter Field nameemailfirstnamelastname'), 
    '5def6b9b044d2c3b21327e51', true)

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/Page_KiboEngage  Create Broadcast/label_HubSpot Contact Properties'))

WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/Page_KiboEngage  Create Broadcast/label_kibopush Custom Fields'))

WebUI.click(findTestObject('Object Repository/hubpost/Page_KiboEngage  Create Broadcast/Page_KiboEngage  Create Broadcast/select_Select a Fieldemailfirstnamelastname'))
