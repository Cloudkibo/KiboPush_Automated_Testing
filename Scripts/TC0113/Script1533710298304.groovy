...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_KiboPush  Broadcast/select_Filter by type...textim (4)'), 
    'gallery', true)

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/span_gallery'))
