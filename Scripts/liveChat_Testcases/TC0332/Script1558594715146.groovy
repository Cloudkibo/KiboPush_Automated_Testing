...
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/i_You replied_fa fa-smile-o'))
WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/span_Frequently Used'))

//WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/i_You replied_center fa fa-smile-o'))
//
//WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/p_GIF'))
