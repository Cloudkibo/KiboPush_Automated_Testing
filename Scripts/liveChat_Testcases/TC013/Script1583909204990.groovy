...
WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/i_Video Tutorial_la la-ellipsis-h'))

WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/span_Test5'))
...
WebUI.verifyEqual(live_chat_subscribers.size(), 1)
