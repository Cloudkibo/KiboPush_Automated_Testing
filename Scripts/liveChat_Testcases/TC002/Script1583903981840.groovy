...
WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/i_Video Tutorial_la la-play-circle'))

WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/h5_Video Tutorial'))

WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/button_'))
WebUI.delay(2)
