...
WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/i_Click here_la la-ellipsis-h'))
WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/span_Test_kibo'))
WebUI.delay(3)
WebUI.verifyTextNotPresent('Test5', false)
WebUI.verifyTextNotPresent('Education123', false)
WebUI.verifyTextNotPresent('AutoPosting Testing Page', false)
WebUI.verifyTextNotPresent('Test4', false)
WebUI.verifyTextNotPresent('Test3', false)
WebUI.verifyTextPresent('Test_kibo', false)
