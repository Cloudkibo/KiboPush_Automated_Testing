...
WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/a_Click here (1)'))

WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/h4_Message Types'))
