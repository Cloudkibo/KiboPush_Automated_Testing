...
WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/div_Select a Custom Field'))

WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/div_City'))
...
WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/button_Save'))

WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/div_Value set successfully'))
