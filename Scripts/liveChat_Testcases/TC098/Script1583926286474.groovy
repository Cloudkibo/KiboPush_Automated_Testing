...
WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Api Settings/span_Manage'))

WebUI.click(findTestObject('Object Repository/Updated_liveChat/Page_KiboChat  Custom Fields/h3_Custom Fields'))
