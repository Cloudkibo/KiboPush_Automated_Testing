...
WebUI.click(findTestObject('Object Repository/bigCommerceChatBot/Page_KiboChat  Commerce Chatbot for Test5/div_Commerce chatbot updated successfully'))
WebUI.click(findTestObject('Object Repository/bigCommerceChatBot/Page_KiboChat  WhatsApp Commerce Chatbot/span'))

WebUI.click(findTestObject('Object Repository/bigCommerceChatBot/Page_KiboChat  Commerce Chatbot for Test5/div_Commerce Chatbot Enabled'))
WebUI.click(findTestObject('Object Repository/bigCommerceChatBot/Page_KiboChat  WhatsApp Commerce Chatbot/span'))
