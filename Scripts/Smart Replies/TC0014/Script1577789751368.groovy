...
WebUI.selectOptionByValue(findTestObject('Object Repository/smart_replies/Page_KiboChat  Bots/select_Filter by StatusActiveDisabledAll'),
	'true', true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/smart_replies/Page_KiboChat  Bots/select_Filter by PagesProduction newUnofficial 5Unofficial 4Unofficial 2Unofficial 1Unofficial 3All'),
	'5cbb7da7107ea274a7dcf901', true)

WebUI.delay(2)


WebUI.verifyElementPresent(findTestObject('Object Repository/smart_replies/Page_KiboChat  Bots/h4_LuckyOrange'), 0)
