...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Dashboard/button_Add New'))

WebUI.setText(findTestObject('Page_KiboPush  Dashboard/input_form-control'), 'helwq')
