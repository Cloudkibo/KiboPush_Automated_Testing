...
WebUI.setText(findTestObject('Page_KiboEngage  Subscribers/input_Name_name'), 'automated testing')

WebUI.click(findTestObject('Page_KiboEngage  Subscribers/button_Create'))
