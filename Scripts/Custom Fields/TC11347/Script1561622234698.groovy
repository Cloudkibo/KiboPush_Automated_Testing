...
WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/div_Faizan RasheeddsdsdProductiona few seconds ago (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboChat  Live Chat/i_Custom Fields_la la-angle-down'))
