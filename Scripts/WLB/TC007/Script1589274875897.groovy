...
WebUI.click(findTestObject('Object Repository/WLB/Page_WhatsApp Router/button_Create New'))

WebUI.click(findTestObject('Object Repository/WLB/Page_WhatsApp Router/h5_Add Whatsapp Invitation URL'))
