...
WebUI.setText(findTestObject('Object Repository/Page_React App/input_Participant Count_count2'), '25')

WebUI.click(findTestObject('Object Repository/Page_React App/button_Save changes'))

WebUI.click(findTestObject('Object Repository/Page_React App/div_URL Edited Successfully'))
