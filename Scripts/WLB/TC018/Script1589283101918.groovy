...
WebUI.setText(findTestObject('Object Repository/Page_React App/input_Base Group Name_baseUrl'), 'Group10')
...
WebUI.verifyTextNotPresent('Group10', false, FailureHandling.STOP_ON_FAILURE)
