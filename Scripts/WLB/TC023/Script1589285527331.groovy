...
WebUI.click(findTestObject('Object Repository/WLB/Page_React App/h5_Delete Confirmation'))

WebUI.setText(findTestObject('Object Repository/WLB/Page_React App/input_Are you sure you want to delete this _c9a449'), 
    'arveen@cloudkibo.com')
