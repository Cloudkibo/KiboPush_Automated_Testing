...
WebUI.setText(findTestObject('Object Repository/Page_KiboPush  Menu/input_Button Title_form-contro (2)'), 'Button1')

WebUI.click(findTestObject('Page_KiboPush  Menu/h7_Open a website'))

WebUI.setText(findTestObject('Object Repository/Page_KiboPush  Menu/input_Open Website_form-contro (2)'), 'www.google.com')
