...
WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Create Menu/h6_Card'))

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Create Menu/h3_Add Card Component'))
