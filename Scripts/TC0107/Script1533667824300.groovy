...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/a_video tutorial (1)'))

WebUI.delay(5)

WebUI.click(findTestObject('Page_KiboPush  Broadcast/a_ytp-youtube-button ytp-butto'))
