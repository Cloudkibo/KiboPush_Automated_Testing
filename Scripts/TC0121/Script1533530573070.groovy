...
WebUI.setText(findTestObject('Object Repository/Page_KiboPush  Broadcast/input_form-control (1)'), 'SampleVideo')

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/span_SampleVideo'))
