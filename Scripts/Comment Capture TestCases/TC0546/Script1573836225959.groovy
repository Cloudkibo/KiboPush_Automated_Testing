...
WebUI.setText(findTestObject('Object Repository/Page_KiboEngage  New Facebook Post/input_Create Carousel using Links_form-control'),
	'https:/facebook.com')

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  New Facebook Post/div_Please enter a valid article link'))
