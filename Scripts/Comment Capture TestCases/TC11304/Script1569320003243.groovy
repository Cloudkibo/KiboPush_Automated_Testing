...
WebUI.click(findTestObject('Page_KiboPush  Comment Capture/a_Edit (1)'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_KiboEngage  Edit Facebook Post/textarea_Create a Facebook Post that will be published on your page_postTextArea'))
