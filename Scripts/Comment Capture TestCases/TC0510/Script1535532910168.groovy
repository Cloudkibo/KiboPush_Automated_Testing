...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Comment Capture/a_next (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Comment Capture/a_previous'))
...
WebUI.verifyEqual(date_page1, date_page2)
