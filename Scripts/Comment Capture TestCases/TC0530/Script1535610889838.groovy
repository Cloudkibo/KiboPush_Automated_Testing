...
WebUI.click(findTestObject('Page_KiboPush  New Facebook Post/button_Save'))

WebUI.scrollToPosition(0, 0)

WebUI.click(findTestObject('Page_KiboPush  New Facebook Post/div_Changes saved successfully'))
