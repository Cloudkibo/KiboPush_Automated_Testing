...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Dashboard/a_next'))
...
WebUI.verifyMatch('1', date1.compareTo(date2).toString(), false) //  WebElement Table = driver.findElement(By.xpath('//table/tbody'))
