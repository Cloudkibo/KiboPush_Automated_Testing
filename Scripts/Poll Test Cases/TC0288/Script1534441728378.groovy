...
WebUI.click(findTestObject('Object Repository/updated_polls/Page_KiboEngage  Polls/button_Delete'))

WebUI.click(findTestObject('Object Repository/updated_polls/Page_KiboEngage  Polls/h5_Delete Poll'))
