...
try {
    List<WebElement> rows_table = driver.findElements(By.xpath('.//*[@id="m_widget4_tab1_content"]/div/div'))

    int rows_count = rows_table.size()

    // println(rows_table.get(0).getText())
    WebUI.verifyGreaterThanOrEqual(rows_count, 5 // println(rows_table.get(0).getText())
        )
}
catch (Exception e) {
    e.printStackTrace()
