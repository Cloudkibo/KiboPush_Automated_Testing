...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Broadcast/div_Image (3)'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Broadcast/button_Next (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Broadcast/div_Select a valid image'))
