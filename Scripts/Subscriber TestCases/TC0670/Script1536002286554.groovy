...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Subscribers/span_Subscribed At'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Subscribers/span_Facebook Page'))
