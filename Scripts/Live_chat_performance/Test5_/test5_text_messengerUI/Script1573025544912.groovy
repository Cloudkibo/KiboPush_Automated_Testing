...
WebUI.verifyTextPresent("congrats35", true)
WebUI.verifyTextPresent("congrats36", true)
WebUI.verifyTextPresent("congrats37", true)
WebUI.verifyTextPresent("congrats38", true)
WebUI.verifyTextPresent("congrats39", true)
WebUI.verifyTextPresent("congrats40", true)
WebUI.verifyTextPresent("congrats41", true)
WebUI.verifyTextPresent("congrats42", true)
