...
upload1.sendKeys(image)

WebUI.delay(5)

WebElement upload2 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload2.sendKeys(image)

WebUI.delay(5)

WebElement upload3 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload3.sendKeys(image)

WebUI.delay(5)

WebElement upload4 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload4.sendKeys(image)

WebUI.delay(5)

WebElement upload5 = driver.findElement(By.xpath('//input[@type=\'file\']'))

upload5.sendKeys(image)

WebUI.delay(5)

WebElement upload6 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload6.sendKeys(image)

WebUI.delay(5)

WebElement upload7 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload7.sendKeys(image)

WebUI.delay(5)

WebElement upload8 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload8.sendKeys(image)

WebUI.delay(5)

WebElement upload9 = driver.findElement(By.xpath('//input[@type=\'file\']'))


upload9.sendKeys(image)
