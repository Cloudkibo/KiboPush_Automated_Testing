...
WebUI.waitForElementHasAttribute(findTestObject('Object Repository/livechat_test/Page_KiboChat  Live Chat/text_message_receive'),'class', 200, FailureHandling.STOP_ON_FAILURE)
WebUI.delay(5)
