...
WebUI.verifyElementPresent(findTestObject('Object Repository/livechat_test/Page_KiboChat  Live Chat/receive_image_url'), 30,FailureHandling.STOP_ON_FAILURE)
WebUI.delay(2)