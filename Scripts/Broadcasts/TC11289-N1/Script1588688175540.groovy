...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_KiboEngage  Broadcast/select_Filter by typetextimagecardgalleryau_ee8050'), 
    'Facebook video', false)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Broadcast/span_Facebook video'))
