...
WebUI.click(findTestObject('Page_KiboPush  Broadcast/a_Use Template'))

//WebUI.click(findTestObject('Page_KiboPush  Broadcast/button_Create New Broadcast'))

CustomKeywords.'custom.newKeyword.clickUsingJS'(findTestObject('Page_KiboPush  Broadcast/button_Create New Broadcast'), 
    10)
