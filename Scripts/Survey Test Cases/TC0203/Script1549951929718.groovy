...
WebUI.click(findTestObject('Page_KiboEngage  Add Survey/button_Send (1)'))

WebUI.click(findTestObject('Page_KiboEngage  Add Survey/div_Survey sent successfully (1)'))
