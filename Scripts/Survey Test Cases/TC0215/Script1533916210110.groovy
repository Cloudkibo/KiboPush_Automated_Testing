...
WebUI.click(findTestObject('Page_KiboPush  Survey/a_Use Template (1) (1) (1) (3)'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Surveys - KiboPush/Page_KiboEngage  Show Templates/select_Filter by Category...Al'), 
    'Customer Behavior', true)
