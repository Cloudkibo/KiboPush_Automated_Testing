...
WebUI.selectOptionByValue(findTestObject('Object Repository/SMS_broadcast/Page_KiboEngage  Broadcasts/select_Select Criteriaiscontainsbegins with'), 
    'contains', true)
WebUI.setText(findTestObject('Object Repository/SMS_broadcast/Page_KiboEngage  Broadcasts/input_Value_targetingText'), 'arveen')
...
WebUI.click(findTestObject('Object Repository/SMS_broadcast/Page_KiboEngage  Broadcasts/div_Broadcast sent successfully'))
