...
WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/i_Video Tutorial_la la-ellipsis-h (1)'))

WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/span_Remove Filters'))
WebUI.delay(4)
