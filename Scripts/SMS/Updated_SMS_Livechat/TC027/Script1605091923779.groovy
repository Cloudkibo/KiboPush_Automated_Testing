...
WebUI.click(findTestObject('Object Repository/new_livechat/Page_KiboChat  Dashboard/i_Sojharo Manghi_la la-check'))

//WebUI.click(findTestObject('Object Repository/new_livechat/Page_KiboPush/i_Sojharo Manghi_fa fa-envelope-open-o'))

WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/h5_Resolve Chat Session'))
//
//WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/button_No'))
//
//WebUI.delay(3)
//WebUI.click(findTestObject('Object Repository/Whatsp_chat/Page_KiboChat  Dashboard/i_Arveen Kumar_la la-check'))
//
