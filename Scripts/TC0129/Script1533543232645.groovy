...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/span_Create New Broadcast (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/a_Use Template (1)'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_KiboPush  Broadcast/select_Filter by Category...Al'), 'Product Use', 
    true)

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/span_Category Product Use'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_KiboPush  Broadcast/select_Filter by Category...Al'), 'Entertain and Engage', 
    true)

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/span_Category Entertain and En'))
