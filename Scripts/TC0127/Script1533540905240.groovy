...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/button_Create New Broadcast'))
...
CustomKeywords.'custom.newKeyword.clickUsingJS'(findTestObject('Object Repository/Page_KiboPush  Broadcast/button_Create New Broadcast'), 10)

WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/div_Broadcast TargetingTextIma'))
