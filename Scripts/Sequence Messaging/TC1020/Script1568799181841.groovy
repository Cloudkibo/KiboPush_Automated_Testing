...
WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Edit Sequence/button_Back (1) (1)'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Edit Sequence/h3_Warning (1) (1)'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Edit Sequence/button_No'))
