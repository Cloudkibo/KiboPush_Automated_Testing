...
WebUI.setText(findTestObject('Page_KiboPush  Dashboard/input_listName (3) (2)'), list)

WebUI.selectOptionByValue(findTestObject('Page_KiboPush  Dashboard/select_Select ConditionFirst N (13)'), 'subscriptionDate', 
    true)
