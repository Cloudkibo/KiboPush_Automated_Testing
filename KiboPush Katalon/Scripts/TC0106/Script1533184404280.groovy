...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Dashboard/span_Broadcasts'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/a_documentation'))

WebUI.switchToWindowTitle('Broadcasts - KiboPush')

WebUI.switchToWindowTitle('KiboPush | Broadcast')
