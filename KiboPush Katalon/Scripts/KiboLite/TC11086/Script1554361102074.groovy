...
WebUI.click(findTestObject('Page_ Dashboard/span_Broadcast (1) (1)'))

WebUI.click(findTestObject('Page_ Business Gateway/a_Target Customers (1) (1)'))

WebUI.click(findTestObject('Page_ Business Gateway/span_Condition (1)'))
