...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Broadcast/div_Video'))

WebUI.verifyElementPresent(findTestObject('Page_KiboPush  Create Broadcast/h4_Video'), 5)
