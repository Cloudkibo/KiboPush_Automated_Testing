...
WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/button_Reset'))

WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/button_Yes'))

WebUI.verifyElementNotPresent(findTestObject('Page_KiboPush  Create Broadcast/text_component'), 5)

WebUI.verifyElementNotPresent(findTestObject('Page_KiboPush  Create Broadcast/text_component1'), 5)
