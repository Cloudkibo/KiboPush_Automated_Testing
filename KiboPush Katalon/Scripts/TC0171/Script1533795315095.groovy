...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Broadcast/div_File'))

WebUI.verifyElementPresent(findTestObject('Page_KiboPush  Create Broadcast/h4_File'), 5)
