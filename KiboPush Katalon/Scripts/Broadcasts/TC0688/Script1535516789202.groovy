...
WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/button_Next (12) (1)'))

WebUI.delay(3)

WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/div_Element in list must have (1)'))
