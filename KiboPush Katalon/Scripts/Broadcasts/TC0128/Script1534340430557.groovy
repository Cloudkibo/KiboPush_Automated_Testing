...
//WebUI.click(findTestObject('Object Repository/Page_KiboPush  Broadcast/div_Edit Template'))
WebDriver driver = DriverFactory.getWebDriver()

List<WebElement> templates = driver.findElements(By.className('m-widget4__item'))
