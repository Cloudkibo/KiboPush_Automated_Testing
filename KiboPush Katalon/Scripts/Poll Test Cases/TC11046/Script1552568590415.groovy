...
WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Show Templates/a_View Template'))

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  View Template/b_Category'))
