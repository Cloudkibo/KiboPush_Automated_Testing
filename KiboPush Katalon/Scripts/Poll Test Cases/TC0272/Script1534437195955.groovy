...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Poll/button_Create Poll (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Create Poll/div_You have either left one o'))
