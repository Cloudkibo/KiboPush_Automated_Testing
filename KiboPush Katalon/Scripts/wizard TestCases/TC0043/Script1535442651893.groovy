...
WebUI.click(findTestObject('Object Repository/Page_KiboPush  Autoposting/a_'))

WebUI.click(findTestObject('Object Repository/Page_KiboPush  Autoposting/button_Delete (1)'))
