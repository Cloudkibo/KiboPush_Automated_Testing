...
WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/div_Media'))

WebUI.verifyElementPresent(findTestObject('Page_KiboPush  Create Broadcast/div_Media_1'), 5)
