...
WebUI.click(findTestObject('Page_KiboPush  Dashboard/input_segmentationType (4) (3)'))

WebUI.setText(findTestObject('Page_KiboPush  Dashboard/input_listName (3) (3)'), '33')
