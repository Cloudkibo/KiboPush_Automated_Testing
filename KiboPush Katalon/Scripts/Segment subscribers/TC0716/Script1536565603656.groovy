...
WebUI.click(findTestObject('Page_KiboPush  Dashboard/h3_Create SubList of Subscribe (8)'))

WebUI.click(findTestObject('Page_KiboPush  Dashboard/input_segmentationType (7)'))

WebUI.setText(findTestObject('Page_KiboPush  Dashboard/input_listName (7)'), '18')
