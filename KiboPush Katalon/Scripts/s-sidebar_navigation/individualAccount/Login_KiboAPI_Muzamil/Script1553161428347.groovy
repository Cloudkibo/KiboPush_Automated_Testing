...
WebUI.setEncryptedText(findTestObject('Page_CloudKibo/input_Sign In_password (2)'), 'ZOMPkeJIpHWb3LMKk986MQ==')
...
WebUI.click(findTestObject('Object Repository/Page_KiboAPI/h3_KiboPush for Developers'))
