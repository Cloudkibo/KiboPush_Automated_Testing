...
WebUI.click(findTestObject('Page_KiboEngage  Dashboard/span_Broadcasting (2)'))

WebUI.click(findTestObject('Page_KiboEngage  Dashboard/span_Surveys (1)'))

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Survey/span_Create New'))

WebUI.click(findTestObject('Object Repository/Page_KiboEngage  Survey/button_Create New Survey'))
