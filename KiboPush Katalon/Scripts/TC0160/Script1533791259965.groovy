...
WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/span_slick-arrow slick-next'))

WebUI.delay(1)

WebUI.click(findTestObject('Page_KiboPush  Create Broadcast/span_Page 3 x'))
